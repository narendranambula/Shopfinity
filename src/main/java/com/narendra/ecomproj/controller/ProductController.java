package com.narendra.ecomproj.controller;

import com.narendra.ecomproj.model.Product;
import com.narendra.ecomproj.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<?> addProduct(@RequestPart("product") Product product,@RequestPart("imageFile") MultipartFile imageFile)
    {
        try
        {
            ...
            return new ResponseEntity<>(service.getProductById(product1.getId()), HttpStatus.CREATED);
        }catch (Exception e) {
